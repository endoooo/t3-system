defmodule T3System.Clubs do
  ...
  """
  def create_club(%Scope{user: %{role: "superuser"}}, attrs) do
    %Club{}
  ...
  """
  def update_club(%Scope{user: %{role: "superuser"}}, %Club{} = club, attrs) do
    club
    |> Club.changeset(attrs)
    |> Repo.update()
  end
  ...
  """
  def delete_club(%Scope{user: %{role: "superuser"}}, %Club{} = club) do
    Repo.delete(club)
  end
